...
export interface CommandSurfaceClient {
    ...
    addChart?: (pageId: string, type: string, deviceId: string, keyId: string, units: string, x: number, y: number, w: number, h: number, totalize: boolean) => Promise<any>;
    updateChart?: (pageId: string, id: string, type: string, deviceId: string, keyId: string, units: string, x: number, y: number, w: number, h: number, totalize: boolean) => Promise<any>;
